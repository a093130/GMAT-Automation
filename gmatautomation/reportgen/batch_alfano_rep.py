...
# -*- coding: utf-8 -*-
"""
	@file batch_alfano_rep.py

	@brief File is module with specialized functions to batch process GMAT Report Files
    from the AlfanoXfer.script.
    ...
    @details:  Sequentially opens .csv formatted GMAT ReportFiles, 
    copies pertinent cells and rows into an .xlsx formatted summary file. 
    incorporates a difference formula in last column, which is fuel residual (or shortage).
    
    Provides specialized processing to extract descriptive informatin from file names. 
    ...
    @remark Change History
        ...
        22 Mar 2022, [CCH] Factored out main to allow generic use of reduce_report
        ...
        with open(fname[0]) as f:
            ...
            for filepath in f:                
                ...
                if os.path.exists(filepath):
                    datadict = rr.lines_from_csv(filepath)
